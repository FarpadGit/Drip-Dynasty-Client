      ...
      case 'simple':
        {
          ...
          this.navlinkStyles.text = 'var(--foreground) sm:var(--background)';
          this.navlinkStyles['hover-bg'] = 'var(--secondary)';
          this.navlinkStyles['hover-text'] = 'var(--secondary-foreground)';
          this.navlinkStyles['active-bg'] = 'var(--secondary)';
          this.navlinkStyles['active-text'] = 'var(--secondary-foreground)';
        }
        break;
      case 'transparent':
        {
          this.variantClasses = 'bg-transparent text-background';
          this.navlinkStyles.text = 'var(--foreground)';
          this.navlinkStyles['hover-bg'] = 'var(--pale-white)';
          this.navlinkStyles['hover-text'] = 'var(--pale-black)';
          this.navlinkStyles['active-bg'] = 'var(--pale-white)';
          this.navlinkStyles['active-text'] = 'var(--pale-black)';
        }
        break;
      case 'drip':
      default:
